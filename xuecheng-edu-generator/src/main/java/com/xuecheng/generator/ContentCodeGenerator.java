...
/**
 * @author MyBatis-Plus
 * @Classname ContentCodeGenerator
...
public class ContentCodeGenerator {
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/xuecheng-edu-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/xc_edu_" + SERVICE_NAME
